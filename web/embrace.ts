/**
 * Adds new browser features not yet in TypeScript's DOM lib (as of Mar 2026):
...
export function initDocumentLoad(): void {
  let retries = 0;
  const emit = () => {
...
export function initExceptions(): void {
  let handling = false;
